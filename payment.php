...
// Display the session variable values
    ...
    // Display the session variable values
    //echo '<p>Transaction Reference Generated: ' . $transactionReference . '</p>';
    //echo '<p>Order ID Generated: ' . $orderId . '</p>';
    //echo 'Session ID Generated: ' . session_id() . '<br>';
    //echo 'Session Status Generated: ' . session_status() . '<br>';
    ...
    <div class="container">
        ...
        <form action="https://gatewaybackend.quickteller.co.ke/ipg-backend/api/checkout"  id="example_form" method="post" class="form" target="_blank">
                <fieldset>
                    ...
                    <input id="redirectUrl" name="redirectUrl" type="text" value="https://kenaija.com/query.php" style="display: none;">
